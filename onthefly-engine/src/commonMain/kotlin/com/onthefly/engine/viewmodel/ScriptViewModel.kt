...
import com.onthefly.engine.data.ScriptRepositoryImpl
import com.onthefly.engine.data.NetworkRequest
import com.onthefly.engine.data.NetworkSource
import com.onthefly.engine.data.ScriptStorage
import com.onthefly.engine.data.DevServerSource
import com.onthefly.engine.data.ScriptUpdateManager
import com.onthefly.engine.data.SharedDataStore
import com.onthefly.engine.data.WebSocketCallback
import com.onthefly.engine.data.WebSocketOptions
import com.onthefly.engine.data.WebSocketSource
import com.onthefly.engine.data.createHttpClient
import com.onthefly.engine.util.escapeJson
import com.onthefly.engine.model.EngineEvent
import com.onthefly.engine.model.NativeAction
import com.onthefly.engine.model.UIComponent
import com.onthefly.engine.model.applyUpdates
import com.onthefly.engine.data.LoadScriptUseCase
import com.onthefly.engine.debug.DebugConfig
...
import com.onthefly.engine.core.QuickJSEngine
import com.onthefly.engine.security.ScriptVerifier
        ...
        for (action in actions) {
            when (action.action) {
                ...
                NativeAction.GET_DEVICE_INFO -> {
                    ...
                    val json = com.onthefly.engine.util.JsonParser.toJsonString(info)
                ...
                NativeAction.SEND_VIEW_DATA -> {
                    com.onthefly.engine.navigation.ViewDataStore.put(action.data)
                }
                NativeAction.LOG -> {
