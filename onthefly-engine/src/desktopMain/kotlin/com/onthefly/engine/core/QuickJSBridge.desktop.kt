...
actual class QuickJSBridge actual constructor() {
    ...
    actual fun registerModule(contextPtr: Long, name: String, source: String) = nativeRegisterModule(contextPtr, name, source)
    actual fun evalModule(contextPtr: Long, script: String, fileName: String): String = nativeEvalModule(contextPtr, script, fileName)
    ...
    private external fun nativeRegisterModule(contextPtr: Long, name: String, source: String)
    private external fun nativeEvalModule(contextPtr: Long, script: String, fileName: String): String
